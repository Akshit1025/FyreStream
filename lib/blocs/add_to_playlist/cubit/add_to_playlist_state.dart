...
class AddToPlaylistState {
  ...
  AddToPlaylistState({required this.playlists});

  AddToPlaylistState copyWith({List<PlaylistItemProperties>? playlists}) {
    return AddToPlaylistState(playlists: playlists ?? this.playlists);
  }
}
