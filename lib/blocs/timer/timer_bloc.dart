...
import 'package:fyrestream/main.dart';
...
class TimerBloc extends Bloc<TimerEvent, TimerState> {
  ...
  TimerBloc({required Ticker ticker, required FyrestreamPlayerCubit fyrestreamPlayer})
      : _ticker = ticker,
  ...
  void _onTimerTicked(_TimerTicked event, Emitter<TimerState> emit) {
    ...
    if (event.duration > 0) {
      ...
      try {
        fyrestreamPlayerCubit.fyrestreamPlayer.pause();
      } catch (e) {
