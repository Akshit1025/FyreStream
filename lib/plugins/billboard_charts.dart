    ...
    if (response.statusCode == 200) {
      ...
      for (var item in songs) {
        ...
        if (imgURL.contains("lazyload-fallback.gif")) {
          imgURL = "https://www.billboard.com/wp-content/themes/vip/pmc-billboard-2021/assets/app/icons/icon-512x512.png";
        } else {
          imgURL = imgURL.replaceAll(RegExp(r'(\d+x\d+)\.jpg$'), '344x344.jpg');
        }
        chartItems.add(ChartItemModel(name: ttl, imageUrl: imgURL, subtitle: lbl));
      }
