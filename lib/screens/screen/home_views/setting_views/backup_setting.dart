          ...
          return ListView(
            children: [
              ...
              SettingTile(
                ...
                onTap: () {
                  FyreStreamDBService.createBackUp().then((value) {
                    if (value) {
                      SnackbarService.showMessage("Backup Successful!");
                    } else {
              ...
              SettingTile(
                ...
                onTap: () {
                  FyreStreamDBService.backupExists().then((value) {
                    if (value) {
                      showDialog(
                          context: context,
                          builder: (context) {
                            return AlertDialog(
                              ...
                              actions: [
                                TextButton(
                                  ...
                                  onPressed: () {
                                    context.pop();
                                    FyreStreamDBService.restoreDB().then((value) {
                                      if (value) {
